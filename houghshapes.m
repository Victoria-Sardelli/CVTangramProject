function [houghtrans, rotRange, sizeRange, flipRange] =  houghshapes(varargin)
% HOUGHSHAPES Uses hough transform to find shapes in an image
% houghtrans = houghshapes(I,s) Returns voting space for squares of
...
% % Function to parse inputs, copied from infindcircles
...
%           'Flip', 'ShapeTemplate'}, varargin{4:end});
%     end
% 
